        ...
        <div class="navbar-content scroll-div " >
           ...
           <br>
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item"><a href="Hasil Pemeriksaan.php" class="nav-link "><span class="pcoded-micon"><i class="fas fa-file-medical"></i></span><span class="pcoded-mtext">Hasil Pemeriksaan</span></a></li>
